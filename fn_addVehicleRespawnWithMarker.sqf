...
_vehicle addMPEventHandler ["MPKilled", {
    _this spawn {
        ...
        sleep 55;    //таймаут на респавн техники     
        //sleep 5;   //debug     
        ...
        //ниже идет ACE интеракшен блок с телепортом что был описан выше, но его добавляет листенер при респавне новой техники
        if (typeName _markerPlaced == "STRING") then {
            _obj = _newVehicle;
            [_obj, {
            params ["_obj"];
